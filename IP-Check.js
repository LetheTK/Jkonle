...
var title =flags.get(obj['countryCode']) + ' '+ Area_check(obj['country']);//+City_check(obj['City']);
var subtitle = City_ValidCheck(obj['city']) + ' ' + ISP_ValidCheck(obj['isp']);
var ip = obj['query'];
var description = "国家" + ":" + Area_check(obj['country']) + '\n' + "城市" + ":" + City_ValidCheck(obj['city']) + '\n' + "运营商" + ":" + ISP_ValidCheck(obj['isp']) + '\n' + "数据中心" + ":" + ISP_ValidCheck(obj['org']) + '\n' + "IP地址" + ":" + obj['query'] + '\n' +'时区:'+ obj['timezone'] + '\n' +'经纬度:'+ '经度'+obj['lon'] + '纬度'+obj['lat'];
